export function PageHeader() {
    return <div className="flex flex-row items-center  sticky top-4">
        <div className="flex flex-row m-8 gap-80 justify-between border-blue border-2 rounded-3xl bg:blur-sm  backdrop-blur-sm"> 
            ...
            <button type="button" className="text-white bg-black mt-2 transition ease-in hover:bg-[#1da1f2]/90 focus:ring-4 focus:outline-none focus:ring-[#1da1f2]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#1da1f2]/55 me-2 mb-2">
